...
from .pytheory_reverb import (
    PYTHEORY_REVERB_MANIFEST,
    PyTheoryReverb,
    PyTheoryReverbParameters,
    SPACES as REVERB_SPACES,
)
from .pytheory_fx import (
    EFFECTS as FX_EFFECTS,
...
BUILTIN_MODULE_TYPES = MappingProxyType({
    ...
    for manifest, module_type in (
        ...
        (RAGA_VOICE_MANIFEST, RagaVoice),
        (MAQAM_MANIFEST, MaqamVoice),
