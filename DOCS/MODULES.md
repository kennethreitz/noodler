...
key; the tree names it and goes to it, and does not remove it. System Output
is the one permanent entry and cannot be removed. Expanding a module entry lists every
